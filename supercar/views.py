...
class CheckoutView(View):
    def get(self, *args, **kwargs):
        try:
            ...
            return render(self.request, "supercar/checkout.html", context)
        except ObjectDoesNotExist:
            messages.info(self.request, "You do not have an active order")
            return redirect("supercar:checkout")
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            if form.is_valid():
                ...
                if payment_option == 'S':
                    return redirect('supercar:payment', payment_option='stripe')
                elif payment_option == 'P':
                    return redirect('supercar:payment', payment_option='paypal')
                else:
                    messages.warning(
            ...
            return redirect("supercar:order-summary")
...
class PaymentView(View):
    def get(self, *args, **kwargs):
        ...
        if order.billing_address:
            ...
            return render(self.request, "supercar/payment.html", context)
        else:
            messages.warning(
...
class OrderSummaryView(LoginRequiredMixin, View):
    def get(self, *args, **kwargs):
        try:
            ...
            return render(self.request, 'supercar/order-summary.html', context)
        except ObjectDoesNotExist:
            messages.warning(self.request, "You do not have an active order")
            return redirect("/")
...
class ItemDetailView(DetailView):
    model = Item
    template_name = 'supercar/product-detail.html'
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.item.filter(item__slug=item.slug).exists():
            ...
            return redirect('supercar:item-detail', slug=slug)
        else:
...
class RequestRefundView(View):
    ...
    def get(self, *args, **kwargs):
        form = RefundForm()
        context = {'form': form}
        return render(self.request, "supercar/request-refund.html", context)
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect("supercar:request-refund")
            except ObjectDoesNotExist:
